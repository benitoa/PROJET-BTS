...
<h1>Formulaire pour ajouter un élève</h1>
			<!-- On précise que le formulaire agit sur generateurpdf en utilisant la méthode post -->

			
				<form id="myform" action="generateurpdf.php" method="post"
				enctype="multipart/form-data">
				<!-- inforation sur le responsable -->
				<label for="nom_responsable">Nom du responsable légal </label><input
					type="text" name="nom_responsable" /><br /><label
					for="numero">Numero de téléphone du responsable légal </label><input
					type="text" name="numero" /><br /> <br /> <label
					for="lien">Lien de parentés </label> <select name="lien">
					<option>pere
				...
				<!-- inforation sur le responsable -->
				<br />
				<label for="nom_responsable2">Nom du deuxième responsable légal </label><input
					type="text" name="nom_responsable2" /><br /> <label
...
<!-- Case à cocher -->
			<div id="case">
				<label for="nom">Matin </label><input type="checkbox" name="Matin" value="matin" />
				<label for="nom">Midi </label> <input type="checkbox" name="Midi"  value="midi" /> 
				<label for="nom">Mercredi Midi </label> <input type="checkbox" name="Mercredi"value="mercredimidi" />
				<label for="nom">Soir </label> <input type="checkbox" name="Soir" value="soir" />
				<label for="nom">Rentre Seul </label><input type="checkbox" name="Seul" value="1" />
			</div>
